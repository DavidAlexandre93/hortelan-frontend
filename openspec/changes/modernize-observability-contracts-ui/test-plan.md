...
| AUTH-02 | Social controls in demo and unconfigured production modes                                       | Component and production-build browser journeys                 | Demo controls create only demo sessions; unconfigured real OAuth controls remain visibly unavailable |
