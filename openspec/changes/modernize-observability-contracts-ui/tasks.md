...
- [ ] 7.1 Migrate authentication and account services to the operation registry and bidirectional DTO validation while preserving backend identity and explicit demo-mode rules, including hash-verified temporary access and truthful social controls for the configured demo deployment.
